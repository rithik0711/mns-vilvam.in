...
const Sidebar = () => {
    ...
    const menuItems = [
        { name: 'Home', path: '/Customer', icon: <HomeIcon /> },
        { name: 'My Orders', path: '/Customer/Orders', icon: <MyOrdersIcon /> },
        { name: 'Profile', path: '/Customer/Profile', icon: <ProfileIcon /> },
        { name: 'Gallery', path: '/Customer/Gallery', icon: <GalleryIcon /> },
        { name: 'Contact Us', path: '/Customer/ContactUs', icon: <PhoneIcon /> },
    ];
                ...
                <div className="bg-white/10 rounded-2xl p-3 flex items-center gap-3 backdrop-blur-sm">
                    ...
                    {!isCollapsed && (
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-orange-200 truncate">Customer Account</p>
                        </div>
                    )}
                </div>
